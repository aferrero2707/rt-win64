...
ls /sources
(cd /sources; patch -N -p0 < ci/rtgui-options-headers.patch; patch -N -p0 < ci/rtgui-pixbuf-env.patch; patch -N -p0 < ci/rtgui-placesbrowser-headers.patch; patch -N -p0 < ci/rtdata-innosetup.patch)
